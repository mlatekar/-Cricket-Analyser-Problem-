...
public class CricketAnalyserTest {
    ...
    private static final String IPL_RUNS_CENSUS_CSV_WRONG_FILE_PATH = "./src/resources/resources/IPL2019FactsheetMostRuns.csv";
    ...
    public void givenIPLRunsCSVFileReturnsCorrectRecords() {
        try {
            int numOfRecords = cricketAnalyser.loadIPLData(CricketAnalyser.IPLCsvFile.IPLRuns, IPL_RUNS_CENSUS_CSV_FILE_PATH);
    ...
    @Test
    public void givenIPLWicketsCSVFileReturnsCorrectRecords() {
        try {
            int numOfRecords = cricketAnalyser.loadIPLData(CricketAnalyser.IPLCsvFile.IPLWicket, IPL_WICKETS_CENSUS_CSV_FILE_PATH);
    ...
    @Test
    public void givenIPLCSVFile_PassWrongFilePath_ShouldThrowException() {
        try {
            cricketAnalyser.loadIPLData(CricketAnalyser.IPLCsvFile.IPLRuns, IPL_RUNS_CENSUS_CSV_WRONG_FILE_PATH);
        } catch (CricketAnalyserException e) {
    ...
    public void givenIPLRunsCSVFile_ShouldReturns_MostRuns() {
        try {
            cricketAnalyser.loadIPLData(CricketAnalyser.IPLCsvFile.IPLRuns, IPL_RUNS_CENSUS_CSV_FILE_PATH);
    ...
    public void givenMostWicketsData_WhenSorted_ShouldReturn_TopBowlingAverage() {
        cricketAnalyser.loadIPLData(CricketAnalyser.IPLCsvFile.IPLWicket, IPL_WICKETS_CENSUS_CSV_FILE_PATH);
    ...
    public void givenIPLData_RunsAndWickets_WhenSorted_ShouldReturn_BestBowlingAnd_BestBattingAverage() {
        cricketAnalyser.loadIPLData(CricketAnalyser.IPLCsvFile.IPLRuns, IPL_RUNS_CENSUS_CSV_FILE_PATH, IPL_WICKETS_CENSUS_CSV_FILE_PATH);
        ...
        Assert.assertEquals("Krishnappa Gowtham", iplRunsCSV[0].player);
    }
